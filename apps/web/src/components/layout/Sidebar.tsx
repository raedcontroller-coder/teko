...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-surface border-r border-outline-variant h-screen flex flex-col fixed left-0 top-0">
      <div className="p-6">
        <Image src="/Teko_logo.svg" alt="Teko Logo" width={200} height={64} className="h-12 w-auto mb-8" />
      </div>
      ...
      <div className="p-4 border-t border-outline-variant">
        <button className="flex items-center gap-3 w-full px-4 py-3 text-error hover:bg-error-container hover:text-on-error-container rounded-lg font-label-md transition-colors">
          <LogOut size={20} />
          <span>Sair</span>
        </button>
      </div>
